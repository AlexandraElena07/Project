...
import { AppBar, ReusableText, RadioButton, TopBar, HeightSpacer, WidthSpacer, Tiles, DescriptionText, ImageCarousel } from '../../components';
    ...
    const getDataFromDatabase = async () => {
        try {
            ...
            navigation.setOptions({
                title: response.data.place.title,
        ...
        <View style={[{ backgroundColor: currentTheme.background }]}>
            <ScrollView showsVerticalScrollIndicator={false} style={[{ backgroundColor: currentTheme.background }]}>
                {place && (
                    <View>
                        <View>
                            <ImageCarousel images={place.imageUrls} />
                            <AppBar
                                top={5}
                                right={5}
