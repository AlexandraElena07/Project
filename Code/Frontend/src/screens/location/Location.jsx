...
const LocationPage = () => {
   ...
   const handlePressPlace = (place) => {
      ...
      //console.log('Marker pressed:', place); // Acest log te va ajuta să vezi ce se întâmplă când apeși pe un marker.
   ...
   const handlePressHotel = (hotel) => {
      //console.log('Marker pressed:', hotel); // Acest log te va ajuta să vezi ce se întâmplă când apeși pe un marker.
      setModalVisible(true);
