...
const FavoriteScreen = ({ navigation }) => {
  ...
  const fetchFavorites = async () => {
    try {
      ...
      //console.log('Fetched favorites:', favoritesData); // Debug: Verificăm structura datelor
      ...
      //console.log('Detailed favorites:', filteredDetailedFavorites); // Debug: Verificăm structura datelor detaliate
      ...
      //console.log('Grouped favorites:', groupedData); // Debug: Verificăm structura datelor grupate
    } catch (error) {
  ...
  const handleCountySelect = async (county) => {
    try {
      ...
      //console.log('Selected county ID:', countyIdStr);
      ...
      const filteredFavorites = initialGroupedFavorites.map(section => {
        const filteredData = section.data.filter(fav => {
          ...
          //console.log('Comparing:', favCountyIdStr, countyIdStr);
          return favCountyIdStr === countyIdStr;
        });
  
        //console.log(`Filtered data for section ${section.title}:`, filteredData);
